...
describe('Main module', () => {
  describe('profile', () => {
    ...
    it('Should return a profile object', () => {
      expect(profile('p')).to.be.instanceof(Object);
    });

    it('Should create a profile object', () => {
      expect(generateProfile().data).to.deep.equal({
  ...
  describe('f3tch', () => {
    it('Should be a function', () => {
      expect(f3tch).to.be.instanceOf(Function);
    });

    it('Should return an instance of Fetch', () => {
      expect(f3tch('url')).to.be.instanceof(Object);
    });
